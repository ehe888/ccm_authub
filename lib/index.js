...
module.exports = function(app, options){
  let _     = require("lodash")
    ...
    ,path = require("path")
    ,fs = require('fs')
    ,HuyiSmsHandler = require('./smsProvider')
  ...
  app.use(function(req, res, next){
    ...
    //Bug fix: Convert all accountname to lowercase
  ...
  app.post("/register", function(req, res, next){
    var name       = req.body.name
        ...
        ,email      = req.body.email        //creator's email, email is username
